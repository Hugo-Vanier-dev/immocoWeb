...
function DashboardPage(){
    ...
    <div className="dashboardContainer grid gap-2 grid-rows-4 grid-cols-3">
        ...
        <div  id="root" className="grid row-start-3 row-span-2 col-start-3 m-2 mt-1 p-2 bg-opacity-50 border-solid border-white border-4 bg-white rounded-xl shadow-md">
        <EmployeeStatsPage />  
        </div>
